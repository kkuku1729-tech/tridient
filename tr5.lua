-- ExpensiveMods для Trident Survival - УЛЬТИМАТИВНАЯ РАБОЧАЯ ВЕРСИЯ
...
-- ПРОСТАЯ И РАБОЧАЯ СИСТЕМА ФЛАЯ
local function StartFly()
    ...
    FlyConnection = RunService.Heartbeat:Connect(function()
        if not FlyEnabled or not BV or not rootPart then return end
...
-- Автоматическое пересоздание при смерти
...
warn("ExpensiveMods loaded successfully! Click circle to open menu.")
